...
class PregnancyResultPage extends StatefulWidget {
  ...
  PregnancyResultPage(this.resultModel, this.rowItem);

  @override
  _PregnancyResultPage createState() {
    return _PregnancyResultPage();
  }
}

class _PregnancyResultPage extends State<PregnancyResultPage> {
