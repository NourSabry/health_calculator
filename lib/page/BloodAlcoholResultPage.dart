...
class BloodAlcoholResultPage extends StatefulWidget {
  final ResultModel resultModel;
  final RowItem rowItem;

  BloodAlcoholResultPage(this.resultModel, this.rowItem);

  @override
  _BloodAlcoholResultPage createState() {
    return _BloodAlcoholResultPage();
  }
}

class _BloodAlcoholResultPage extends State<BloodAlcoholResultPage> {
